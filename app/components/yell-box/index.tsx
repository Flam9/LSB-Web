...
export const YellBox = () => (
    <Box
        minHeight="200px"
        background="linear-gradient(to bottom, rgba(49, 48, 90, 1) 0%, rgba(20, 20, 37, 1) 50%, rgba(49, 48, 90, 1) 100%)"
        position="relative"
        ...
        _before={{
            ...
            right: 0,
            backgroundImage:
                'linear-gradient(to bottom, rgba(0, 0, 0, 0.15) 0%, rgba(0, 0, 0, 0.5) 50%, rgba(0, 0, 0, 0.15) 100%)',
    ...
    >
        ...
        >
            ...
            <YellBoxMsg time="12:35:58 AM" name="Cabinman">
                WTS
                <AutoTranslate>Scp. Harness +1</AutoTranslate> /<AutoTranslate>Serket Ring</AutoTranslate> /
